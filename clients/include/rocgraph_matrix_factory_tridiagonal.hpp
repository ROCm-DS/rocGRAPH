...
#pragma once
#ifndef ROCGRAPH_MATRIX_FACTORY_TRIDIAGONAL_HPP
#define ROCGRAPH_MATRIX_FACTORY_TRIDIAGONAL_HPP

#include "rocgraph_matrix_factory_base.hpp"

template <typename T, typename I = rocgraph_int, typename J = rocgraph_int>
struct rocgraph_matrix_factory_tridiagonal : public rocgraph_matrix_factory_base<T, I, J>
{
private:
    J m_l, m_u;

public:
    rocgraph_matrix_factory_tridiagonal(J l, J u);
...
#endif // ROCGRAPH_MATRIX_FACTORY_TRIDIAGONAL_HPP
