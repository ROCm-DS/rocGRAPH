...
#pragma once
#ifndef ROCGRAPH_MATRIX_FACTORY_LAPLACE2D_HPP
#define ROCGRAPH_MATRIX_FACTORY_LAPLACE2D_HPP

#include "rocgraph_matrix_factory_base.hpp"

template <typename T, typename I = rocgraph_int, typename J = rocgraph_int>
struct rocgraph_matrix_factory_laplace2d : public rocgraph_matrix_factory_base<T, I, J>
{
private:
    J m_dimx, m_dimy;

public:
    rocgraph_matrix_factory_laplace2d(J dimx, J dimy);
...
#endif // ROCGRAPH_MATRIX_FACTORY_LAPLACE2D_HPP
