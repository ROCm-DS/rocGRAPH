...
#include "testing_rocgraph_jaccard_coefficients.hpp"
#include "rocgraph/rocgraph.h"
#include "similarity_test.hpp"
#include "testing.hpp"
static void AllPairsJaccardTopk(const Arguments& arg)
{
...
static void WeightedAllPairsJaccardTopk(const Arguments& arg)
{
...
static void Jaccard(const Arguments& arg)
{
...
static void WeightedJaccard(const Arguments& arg)
{
...
static void AllPairsJaccard(const Arguments& arg)
{
...
static void WeightedAllPairsJaccard(const Arguments& arg)
{
...
template <typename T>
void testing_rocgraph_jaccard_coefficients_bad_arg(const Arguments& arg)
{
#ifdef TO_FILL
    ...
    auto                           ret = rocgraph_jaccard_coefficients(
...
template <typename T>
void testing_rocgraph_jaccard_coefficients(const Arguments& arg)
{
#ifdef TO_FILL
    //
    // Unit check.
...
#define INSTANTIATE(TYPE)                                                                    \
    template void testing_rocgraph_jaccard_coefficients_bad_arg<TYPE>(const Arguments& arg); \
    template void testing_rocgraph_jaccard_coefficients<TYPE>(const Arguments& arg)
INSTANTIATE(float);
INSTANTIATE(double);

void testing_rocgraph_jaccard_coefficients_extra(const Arguments& arg)
{
    testing_dispatch_extra(arg,
                           ...
                           "AllPairsJaccard",
                           AllPairsJaccard,
                           "WeightedAllPairsJaccard",
                           WeightedAllPairsJaccard,
                           "AllPairsJaccardTopk",
                           AllPairsJaccardTopk,
                           "WeightedAllPairsJaccardTopk",
                           WeightedAllPairsJaccardTopk);
}
