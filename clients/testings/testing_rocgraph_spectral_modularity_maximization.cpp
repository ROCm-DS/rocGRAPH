...
#include "testing_rocgraph_spectral_modularity_maximization.hpp"
...
template <typename T>
void testing_rocgraph_spectral_modularity_maximization_bad_arg(const Arguments& arg)
{
#ifdef TO_FILL
    ...
    auto                           ret = rocgraph_spectral_modularity_maximization(handle,
                                                         graph,
                                                         n_clusters,
                                                         n_eigenvectors,
                                                         evs_tolerance,
...
template <typename T>
void testing_rocgraph_spectral_modularity_maximization(const Arguments& arg)
{
#ifdef TO_FILL
...
#define INSTANTIATE(TYPE)                                                          \
    template void testing_rocgraph_spectral_modularity_maximization_bad_arg<TYPE>( \
        const Arguments& arg);                                                     \
    template void testing_rocgraph_spectral_modularity_maximization<TYPE>(const Arguments& arg)
INSTANTIATE(float);
INSTANTIATE(double);

void testing_rocgraph_spectral_modularity_maximization_extra(const Arguments& arg)
{
