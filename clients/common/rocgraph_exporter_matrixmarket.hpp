...
#pragma once
#ifndef ROCGRAPH_EXPORTER_MATRIXMARKET_HPP
#define ROCGRAPH_EXPORTER_MATRIXMARKET_HPP

#include "rocgraph_exporter.hpp"

class rocgraph_exporter_matrixmarket : public rocgraph_exporter<rocgraph_exporter_matrixmarket>
{
protected:
    std::string m_filename{};

public:
    ~rocgraph_exporter_matrixmarket();
    rocgraph_exporter_matrixmarket(const std::string& filename_);
