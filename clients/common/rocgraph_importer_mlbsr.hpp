...
#pragma once
#ifndef ROCGRAPH_IMPORTER_MLBSR_HPP
#define ROCGRAPH_IMPORTER_MLBSR_HPP
#include "rocgraph_importer.hpp"

class rocgraph_importer_mlbsr : public rocgraph_importer<rocgraph_importer_mlbsr>
{
protected:
    std::string m_filename;

public:
    rocgraph_importer_mlbsr(const std::string& filename_);
    ~rocgraph_importer_mlbsr();
