...
#pragma once
#ifndef ROCGRAPH_EXPORTER_ASCII_HPP
#define ROCGRAPH_EXPORTER_ASCII_HPP

#include "rocgraph_exporter.hpp"

class rocgraph_exporter_ascii : public rocgraph_exporter<rocgraph_exporter_ascii>
{
protected:
    std::string m_filename{};

public:
    ~rocgraph_exporter_ascii();
    rocgraph_exporter_ascii(const std::string& filename_);
