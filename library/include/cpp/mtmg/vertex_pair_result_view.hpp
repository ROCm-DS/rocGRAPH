 ...
 */
        ...
        {
            using parent_t
                = detail::device_shared_device_span_tuple_t<vertex_t, vertex_t, result_t>;

        public:
            vertex_pair_result_view_t(parent_t&& other)
   ...
   */
            ...
            std::tuple<rmm::device_uvector<vertex_t>,
                ...
                gather(handle_t const&                   handle,
                       ...
                       std::optional<rocgraph::mtmg::renumber_map_view_t<vertex_t>>&
                           renumber_map_view);
        };
