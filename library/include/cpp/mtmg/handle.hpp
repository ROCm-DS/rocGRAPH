 ...
 */
   ...
   */
            handle_t(raft::handle_t const& raft_handle,
                     int                   thread_rank,
                     rmm::cuda_device_id   device_id)
                : raft_handle_(raft_handle)
                , thread_rank_(thread_rank)
                , device_id_raii_(device_id)
            {
            }
   ...
   */
            raft::handle_t const& raft_handle() const
            {
                return raft_handle_;
            }
   ...
   */
            ...
            {
                raft_handle_.sync_stream(stream);
            }
   ...
   */
            ...
            {
                return get_thrust_policy(get_stream());
            }
   ...
   */
            int get_size() const
            {
                return raft_handle_.get_comms().get_size();
            }
   ...
   */
            int get_rank() const
            {
                return raft_handle_.get_comms().get_rank();
            }
