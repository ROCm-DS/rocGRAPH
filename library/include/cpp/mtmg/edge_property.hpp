 ...
 */
        ...
        class edge_property_t
            : public detail::device_shared_wrapper_t<
                  rocgraph::edge_property_t<typename graph_view_t::wrapped_t, property_t>>
        {
        public:
   ...
   */
            auto view()
            {
                ...
                using buffer_t =
                    typename rocgraph::edge_property_t<typename graph_view_t::wrapped_t,
                                                       property_t>::buffer_type;
                ...
                std::for_each(parent_t::objects_.begin(),
                              parent_t::objects_.end(),
                              [&result](auto& p) { result.set(p.first, p.second.view()); });
