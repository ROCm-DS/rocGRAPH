 ...
 * @param[in] graph                             rocGRAPH graph descriptor, should contain the
 ...
 *
 * @throws                                  rocgraph::logic_error if `result == nullptr` or
 ...
 */
    ...
    enum class rocgraph_cc_t
    {
        ROCGRAPH_STRONG, ///> Strongly Connected Components
 ...
 *
 * @param[in] graph               rocGRAPH graph descriptor, should contain the connectivity
 ...
 * @param[in]  handle                Library handle (RAFT). If a communicator is set in the
 * handle,
 * @param[in]  graph                 rocGRAPH COO graph
 ...
 *
 * @throws rocgraph::logic_error on erroneous input arguments.
 *
 * @tparam vertex_t Type of vertex identifiers. Needs to be an integral type.
 * @tparam edge_t Type of edge identifiers. Needs to be an integral type.
 * @tparam multi_gpu Flag indicating whether template instantiation should target single-GPU (false)
 ...
 * rocgraph::sssp function in a sequentially executed loop might be faster. This algorithms currently
 ...
 *
 * @throws rocgraph::logic_error on erroneous input arguments or if fails to converge before @p
 * max_iterations.
 *
 * @tparam vertex_t Type of vertex identifiers. Needs to be an integral type.
 * @tparam edge_t Type of edge identifiers. Needs to be an integral type.
 ...
 * be generated for each instance.
 *
 * @throws                 rocgraph::logic_error if the graph is unweighted
 *
 * @tparam vertex_t Type of vertex identifiers. Needs to be an integral type.
 * @tparam edge_t Type of edge identifiers. Needs to be an integral type.
 * @tparam weight_t Type of edge weights. Needs to be a floating point type.
 ...
 */
    template <typename vertex_t, typename edge_t, bool multi_gpu>
    std::tuple<rmm::device_uvector<size_t>, rmm::device_uvector<vertex_t>>
