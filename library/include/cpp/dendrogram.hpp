...
namespace rocgraph
{
    ...
    public:
        ...
        {
            return level_ptr_.size() - 1;
        }

        size_t num_levels() const
        {
            return level_ptr_.size();
        }
        ...
        size_t get_level_size_nocheck(size_t level) const
        {
            return level_ptr_[level]->size();
        }

        vertex_t get_level_first_index_nocheck(size_t level) const
        {
            return level_first_index_[level];
        }

        vertex_t const* current_level_begin() const
        {
            return get_level_ptr_nocheck(current_level());
        }

        vertex_t const* current_level_end() const
        {
            return current_level_begin() + current_level_size();
        }

        vertex_t* current_level_begin()
        {
            return get_level_ptr_nocheck(current_level());
        }

        vertex_t* current_level_end()
        {
            return current_level_begin() + current_level_size();
        }

        size_t current_level_size() const
        {
            return get_level_size_nocheck(current_level());
        }
