...
namespace rocgraph
{
    ...
    namespace detail
    {
        ...
        template <typename InputIterator, typename OutputValueType>
        std::enable_if_t<std::is_arithmetic<OutputValueType>::value, void>
            device_isend_impl(raft::comms::comms_t const& comm,
                              InputIterator               input_first,
                              size_t                      count,
                              int                         dst,
        ...
        struct device_isend_tuple_iterator_element_impl
        {
            ...
            {
                using output_value_t = typename thrust::tuple_element<
                    I,
                    typename std::iterator_traits<OutputIterator>::value_type>::type;
        ...
        struct device_irecv_tuple_iterator_element_impl
        {
            void run(raft::comms::comms_t const& comm,
                     ...
                     raft::comms::request_t*     requests) const
            {
                using input_value_t = typename thrust::tuple_element<
                    I,
        ...
        struct device_sendrecv_tuple_iterator_element_impl
        {
                     ...
                     rmm::cuda_stream_view       stream_view) const
            {
                ...
                auto tuple_element_input_first  = thrust::get<I>(input_first.get_iterator_tuple());
                auto tuple_element_output_first = thrust::get<I>(output_first.get_iterator_tuple());
                device_sendrecv_impl<decltype(tuple_element_input_first),
                                     decltype(tuple_element_output_first)>(
                    comm,
                    tuple_element_input_first,
                    tx_count,
                    dst,
                    ...
                    src,
                    stream_view.value());
                device_sendrecv_tuple_iterator_element_impl<InputIterator,
                                                            OutputIterator,
                                                            I + 1,
                                                            N>()
                    .run(
        ...
        struct device_multicast_sendrecv_tuple_iterator_element_impl
        {
                     ...
                     rmm::cuda_stream_view       stream_view) const
            {
                ...
                device_multicast_sendrecv_impl<decltype(tuple_element_input_first),
                    ...
                    rx_src_ranks,
                    stream_view);
                device_multicast_sendrecv_tuple_iterator_element_impl<InputIterator,
                                                                      OutputIterator,
                                                                      I + 1,
                                                                      N>()
                    .run(comm,
        ...
        template <typename InputIterator, typename OutputIterator, size_t I>
        struct device_multicast_sendrecv_tuple_iterator_element_impl<InputIterator,
                                                                     OutputIterator,
                                                                     I,
                                                                     I>
        {
                              ...
                              rmm::cuda_stream_view       stream_view)
        {
            static_assert(
                std::is_same<typename std::iterator_traits<InputIterator>::value_type,
                             typename std::iterator_traits<OutputIterator>::value_type>::value);
            comm.bcast(iter_to_raw_ptr(input_first),
                       iter_to_raw_ptr(output_first),
                       count,
                       root,
                       stream_view.value());
                                  ...
                                  rmm::cuda_stream_view       stream_view)
        {
            static_assert(
                std::is_same<typename std::iterator_traits<InputIterator>::value_type,
                             typename std::iterator_traits<OutputIterator>::value_type>::value);
            comm.allreduce(iter_to_raw_ptr(input_first),
                           iter_to_raw_ptr(output_first),
                           count,
                           op,
                           stream_view.value());
        ...
        struct device_allreduce_tuple_iterator_element_impl
        {
                     ...
                     rmm::cuda_stream_view       stream_view) const
            {
                device_allreduce_impl(comm,
                                      ...
                                      op,
                                      stream_view);
                device_allreduce_tuple_iterator_element_impl<InputIterator,
                                                             OutputIterator,
                                                             I + 1,
                                                             N>()
        ...
        struct device_allgatherv_tuple_iterator_element_impl
        {
                     ...
                     rmm::cuda_stream_view       stream_view) const
            {
                device_allgatherv_impl(comm,
                                       ...
                                       displacements,
                                       stream_view);
                device_allgatherv_tuple_iterator_element_impl<InputIterator,
                                                              OutputIterator,
                                                              I + 1,
                                                              N>()
        ...
        struct device_gatherv_tuple_iterator_element_impl
        {
                     ...
                     rmm::cuda_stream_view       stream_view) const
            {
                device_gatherv_impl(comm,
                                    ...
                                    root,
                                    stream_view);
                device_gatherv_tuple_iterator_element_impl<InputIterator,
                                                           OutputIterator,
                                                           I + 1,
                                                           N>()
                    .run(comm,
                     ...
                     raft::comms::request_t*     requests)
    {
        static_assert(
            ...
            == thrust::tuple_size<
                typename thrust::iterator_traits<OutputIterator>::value_type>::value);

        size_t constexpr tuple_size = thrust::tuple_size<
            typename thrust::iterator_traits<InputIterator>::value_type>::value;

        detail::device_isend_tuple_iterator_element_impl<InputIterator,
                                                         OutputIterator,
                                                         size_t{0},
                                                         tuple_size>()
            .run(comm, input_first, count, dst, base_tag, requests);
                     ...
                     raft::comms::request_t*     requests)
    {
        ...
        detail::device_irecv_tuple_iterator_element_impl<InputIterator,
                                                         OutputIterator,
                                                         size_t{0},
                                                         tuple_size>()
            .run(comm, output_first, count, src, base_tag, requests);
                     ...
                     rmm::cuda_stream_view       stream_view)
    {
        ...
        detail::device_bcast_tuple_iterator_element_impl<InputIterator,
                                                         OutputIterator,
                                                         size_t{0},
                                                         tuple_size>()
            .run(comm, input_first, output_first, count, root, stream_view);
    ...
    std::enable_if_t<
        ...
        device_gatherv(raft::comms::comms_t const& comm,
                       ...
                       rmm::cuda_stream_view       stream_view)
    {
        detail::device_gatherv_impl(comm,
                                    input_first,
                                    output_first,
                                    sendcount,
                                    recvcounts,
