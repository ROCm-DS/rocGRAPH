...
namespace rocgraph
{
    ...
    namespace detail
    {
        ...
        public:
            ...
            raft::device_span<edge_t const> offsets() const
            {
                return offsets_;
            }
            raft::device_span<vertex_t const> indices() const
            {
                return indices_;
            }
    ...
    public:
        ...
        std::optional<vertex_t> major_hypersparse_first() const
        {
            return major_hypersparse_first_;
        }

        vertex_t major_range_first() const
        {
            return major_range_first_;
        }
        vertex_t major_range_last() const
        {
        ...
        vertex_t minor_range_last() const
        {
            return minor_range_last_;
        }

        vertex_t major_value_start_offset() const
        {
