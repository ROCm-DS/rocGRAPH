    ...
    namespace spectral
    {
        ...
        struct kmeans_solver_t
        {
                                                        ...
                                                        index_type_t* __restrict__ codes) const
            {
                ...
                auto centroids = raft::make_device_matrix<value_type_t, index_type_t>(
                    handle, config_.n_clusters, dim);
                auto weight
                    = raft::make_device_vector<value_type_t, index_type_t>(handle, n_obs_vecs);
                ...
                auto sw = std::make_optional(
                    (raft::device_vector_view<const value_type_t>)weight.view());
            ...
            auto const& get_config(void) const
            {
                return config_;
            }
