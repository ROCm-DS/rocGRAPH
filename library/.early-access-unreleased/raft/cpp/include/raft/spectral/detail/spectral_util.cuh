    ...
    namespace spectral
    {
                                    ...
                                    weight_t*              eigVecs)
        {
            ...
            //   TODO: in-place transpose
            {
                ...
                RAFT_CUDA_TRY(cudaMemcpyAsync(eigVecs,
                                              work.raw(),
            ...
            raft::spectral::matrix::laplacian_matrix_t<vertex_t, weight_t> const& B)
        {
            ...
            thrust::for_each(thrust_exec_policy,
                             thrust::make_zip_iterator(
                                 thrust::make_tuple(thrust::device_pointer_cast(clusters),
                                                    thrust::device_pointer_cast(part_i.raw()))),
                             thrust::make_zip_iterator(
                                 thrust::make_tuple(thrust::device_pointer_cast(clusters + n),
