 ...
 */
    ...
    void normalTable(raft::resources const&                                     handle,
                     ...
                     std::variant<raft::device_vector_view<const OutputValueType, IndexType>,
                                  OutputValueType>                              sigma,
 ...
 */
    ...
    {
        detail::fill(
            rng_state, out.data_handle(), out.extent(0), val, resource::get_cuda_stream(handle));
    }
 ...
 */
                          ...
                          OutType                scale)
    {
        detail::scaled_bernoulli(
            rng_state, ptr, len, prob, scale, resource::get_cuda_stream(handle));
    }
 ...
 */
    ...
    std::enable_if_t<std::is_integral_v<OutType>>
        discrete(raft::resources const&                                handle,
                 RngState&                                             rng_state,
