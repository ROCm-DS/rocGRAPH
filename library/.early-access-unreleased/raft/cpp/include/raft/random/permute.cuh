...
namespace raft::random
{
    ...
    namespace permute_impl
    {
        ...
        template <typename PermutationIndexType,
                  ...
                  typename Layout>
        struct perms_out_view<
            std::optional<raft::device_vector_view<PermutationIndexType, IdxType>>,
        ...
        template <typename T, typename InputOutputValueType, typename IdxType, typename Layout>
        using perms_out_view_t =
            typename perms_out_view<T, InputOutputValueType, IdxType, Layout>::type;
