 ...
 */
    ...
    {
        RAFT_EXPECTS(raft::is_row_or_column_major(in),
                     "Matrix layout must be row- or column-major");
        ...
        RAFT_EXPECTS(coords.row2 <= in.extent(0),
                     "row2 must be <= number of rows in the input matrix");
