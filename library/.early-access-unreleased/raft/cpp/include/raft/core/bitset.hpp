 ...
 */
   ...
   */
        ...
        inline _RAFT_HOST_DEVICE auto data() const -> const bitset_t*
        {
            return bitset_ptr_;
        }
        /**
   ...
   */
        ...
        {
            return raft::make_device_vector_view<const bitset_t, index_t>(bitset_ptr_,
                                                                          n_elements());
        }
 ...
 */
   ...
   */
        ...
        inline auto data() const -> const bitset_t*
        {
            return bitset_.data();
        }
        /**
   ...
   */
        ...
        [[nodiscard]] inline auto
            to_mdspan() const -> raft::device_vector_view<const bitset_t, index_t>
        {
            return raft::make_device_vector_view<const bitset_t, index_t>(bitset_.data(),
                                                                          n_elements());
        }
   ...
   * @param res RAFT resources
   */
        bool any(const raft::resources& res)
        {
            return count(res) > 0;
        }
        /**
   ...
   * @param res RAFT resources
   */
        bool all(const raft::resources& res)
        {
            return count(res) == bitset_len_;
        }
        /**
   * @brief Checks if none of the bits are set to true in the bitset.
   * @param res RAFT resources
   */
        bool none(const raft::resources& res)
        {
            return count(res) == 0;
        }
