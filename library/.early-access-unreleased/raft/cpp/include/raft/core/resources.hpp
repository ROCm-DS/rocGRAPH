 ...
 */
    ...
    public:
        ...
        resources()
            : factories_(resource::resource_type::LAST_KEY)
            , resources_(resource::resource_type::LAST_KEY)
        {
   ...
   */
        ...
        res_t* get_resource(resource::resource_type resource_type) const
        {
            ...
            {
                RAFT_EXPECTS(factories_.at(resource_type).first
                                 != resource::resource_type::LAST_KEY,
