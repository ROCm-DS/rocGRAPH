 ...
 */
    ...
    {
        static_assert(
            (std::is_same<typename std::remove_const<bitmap_t>::type, uint32_t>::value
   ...
   */
        inline _RAFT_HOST_DEVICE void
            set(const index_t row, const index_t col, bool new_value) const;
