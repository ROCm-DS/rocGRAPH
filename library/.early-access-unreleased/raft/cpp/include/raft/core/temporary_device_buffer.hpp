 ...
 */
   ...
   */
            ...
            , device_id_{get_device_for_address(data)}
        {
            if(device_id_ == -1)
            {
                ...
                raft::copy(
                    device_data.data_handle(), data, length_, resource::get_cuda_stream(handle));
   ...
   */
        auto view() -> view_type
        {
            ...
            {
                return make_mdspan<ElementType, index_type, LayoutPolicy, false, true>(
                    original_data_, extents_);
            }
        }
 ...
 */
    ...
    auto make_temporary_device_buffer(raft::resources const&               handle,
                                      ...
                                      bool                                 write_back = false)
    {
        return temporary_device_buffer<ElementType,
                                       decltype(extents),
                                       LayoutPolicy,
 ...
 */
                                                ...
                                                raft::extents<IndexType, Extents...> extents)
    {
        return temporary_device_buffer<ElementType,
                                       decltype(extents),
                                       LayoutPolicy,
                                       ContainerPolicy>(handle, data, extents, true);
    }
