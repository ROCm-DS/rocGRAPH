...
namespace raft
{
    ...
    RAFT_INLINE_CONDITIONAL logger::logger(std::string const& name_)
    ...
    RAFT_INLINE_CONDITIONAL void logger::set_flush(void (*flush)())
    {
        pimpl->sink->set_flush(flush);
    }
    ...
    RAFT_INLINE_CONDITIONAL std::string logger::get_pattern() const
    {
        return pimpl->cur_pattern;
    }
    ...
    RAFT_INLINE_CONDITIONAL void logger::flush()
    {
        pimpl->spdlogger->flush();
    }
