 ...
 */
    ...
    using device_csr_matrix = csr_matrix<ElementType,
                                         IndptrType,
                                         IndicesType,
                                         NZType,
                                         true,
 ...
 */
    ...
    struct is_device_csr_matrix<device_csr_matrix<ElementType,
                                                  IndptrType,
                                                  IndicesType,
                                                  NZType,
                                                  ContainerPolicy,
 ...
 */
        ...
        device_compressed_structure_view<IndptrType, IndicesType, NZType> structure)
    {
        ...
        return device_csr_matrix_view<ElementType, IndptrType, IndicesType, NZType>(elements,
                                                                                    structure);
    }
 ...
 */
    ...
    auto make_device_compressed_structure(raft::resources const& handle,
                                          ...
                                          NZType                 nnz = 0)
    {
        return device_compressed_structure<IndptrType, IndicesType, NZType>(
            handle, n_rows, n_cols, nnz);
    }
