...
namespace raft::core
{
    ...
    _RAFT_HOST_DEVICE inline bool
        bitset_view<bitset_t, index_t>::test(const index_t sample_index) const
    {
    ...
    template <typename bitset_t, typename index_t>
    _RAFT_HOST_DEVICE bool
        bitset_view<bitset_t, index_t>::operator[](const index_t sample_index) const
    {
