 ...
 */
    ...
    using pinned_mdspan
        = mdspan<ElementType, Extents, LayoutPolicy, pinned_accessor<AccessorPolicy>>;
 ...
 */
    template <typename ElementType,
              typename IndexType    = std::uint32_t,
              typename LayoutPolicy = layout_right_padded<ElementType>>
    auto constexpr make_pinned_aligned_matrix_view(ElementType* ptr,
                                                   IndexType    n_rows,
                                                   IndexType    n_cols)
    {
        ...
        return pinned_aligned_matrix_view<ElementType, IndexType, LayoutPolicy>{aligned_pointer,
                                                                                extents};
    }
