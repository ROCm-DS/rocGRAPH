 ...
 */
    ...
    {
    public:
        explicit device_memory_resource(std::shared_ptr<rmm::mr::device_memory_resource> mr)
            : mr_(mr)
        {
        }
 ...
 */
    ...
    {
    public:
        explicit workspace_resource_factory(std::shared_ptr<rmm::mr::device_memory_resource> mr
                                            = {nullptr},
        ...
        auto get_resource_type() -> resource_type override
        {
            return resource_type::WORKSPACE_RESOURCE;
        }
        auto make_resource() -> resource* override
        {
            ...
            -> std::shared_ptr<rmm::mr::device_memory_resource>
        {
            ...
            RAFT_LOG_DEBUG("Setting the workspace pool resource; memory limit = %zu, initial pool "
                           "size = %zu, max pool "
                           "size = %zu.",
                           limit,
                           min_size,
   ...
   */
        static inline auto
            default_plain_resource() -> std::shared_ptr<rmm::mr::device_memory_resource>
        {
 ...
 */
        ...
        -> rmm::mr::limiting_resource_adaptor<rmm::mr::device_memory_resource>*
    {
        ...
        return res
            .get_resource<rmm::mr::limiting_resource_adaptor<rmm::mr::device_memory_resource>>(
 ...
 *
 */
    inline void set_workspace_to_pool_resource(resources const&           res,
                                               std::optional<std::size_t> allocation_limit
                                               = std::nullopt)
    {
        if(!allocation_limit.has_value())
        {
            allocation_limit = get_workspace_total_bytes(res);
        }
        res.add_resource_factory(std::make_shared<workspace_resource_factory>(
 ...
 *   the total amount of memory in bytes available to the temporary workspace resources.
 */
    inline void set_workspace_to_global_resource(resources const&           res,
                                                 std::optional<std::size_t> allocation_limit
                                                 = std::nullopt)
    {
        res.add_resource_factory(std::make_shared<workspace_resource_factory>(
    ...
    inline auto
        get_large_workspace_resource(resources const& res) -> rmm::mr::device_memory_resource*
    {
        ...
        return res.get_resource<rmm::mr::device_memory_resource>(
