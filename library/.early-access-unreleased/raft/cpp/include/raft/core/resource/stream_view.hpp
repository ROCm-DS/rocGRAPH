...
namespace raft::resource
{
    ...
    {
        stream_view_resource(raft::stream_view view = raft::stream_view_per_thread)
            : stream(view)
        {
        }
 ...
 */
    ...
    public:
        ...
        {
            return resource_type::STREAM_VIEW;
        }
        resource* make_resource() override
        {
            return new stream_view_resource(stream);
        }
 ...
 */
    ...
    {
        sync_stream_view(res, get_stream_view(res));
    }
