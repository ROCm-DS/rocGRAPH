...
namespace raft::resource
{
    ...
    {
    public:
        comms_resource(std::shared_ptr<comms::comms_t> comnumicator)
            : communicator_(comnumicator)
        {
        }
 ...
 */
    ...
    {
    public:
        comms_resource_factory(std::shared_ptr<comms::comms_t> communicator)
        ...
        {
            return resource_type::COMMUNICATOR;
        }

        resource* make_resource() override
        {
            return new comms_resource(communicator_);
        }
