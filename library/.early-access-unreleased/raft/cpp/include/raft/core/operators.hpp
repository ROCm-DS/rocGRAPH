 ...
 */
    ...
    struct const_op
    {
        ...
        constexpr explicit const_op(const ScalarT& s)
            : scalar{s}
        {
        }
 ...
 */
    ...
    struct plug_const_op
    {
        ...
        constexpr plug_const_op(const ConstT& s, BinaryOpT o)
            : c{s}
            , composed_op{o}
        {
        }
 ...
 */
    ...
    struct compose_op
    {
        ...
        constexpr explicit compose_op(OpsT... ops)
            : ops{ops...}
        {
        }
 ...
 */
    ...
    private:
        ...
        constexpr RAFT_INLINE_FUNCTION auto map_args(std::index_sequence<I...>,
                                                     Args&&... args) const
        {
