 ...
 */
        ...
        void mapThenSumReduce(OutType*      out,
                              IdxType       len,
                              MapOp         map,
                              cudaStream_t  stream,
                              const InType* in,
        ...
        {
            detail::
                mapThenReduceImpl<InType, OutType, IdxType, MapOp, detail::sum_tag, TPB, Args...>(
 ...
 */
        template <typename InType,
                  ...
                  typename OutType = InType,
                  typename... Args>
        [[deprecated("Use function `mapReduce` from `raft/linalg/map_reduce.cuh")]] void
            mapThenReduce(OutType*      out,
                          size_t        len,
                          OutType       neutral,
                          MapOp         map,
                          ReduceLambda  op,
