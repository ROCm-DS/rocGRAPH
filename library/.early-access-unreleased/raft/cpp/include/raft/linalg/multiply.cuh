 ...
 */
        ...
        void multiplyScalar(
            out_t* out, const in_t* in, in_t scalar, IdxType len, cudaStream_t stream)
        {
 ...
 */
            ...
            raft::host_scalar_view<const typename InType::value_type, ScalarIdxType> scalar)
        {
            ...
            {
                multiplyScalar<in_value_t, out_value_t, std::uint32_t>(
                    out.data_handle(),
                    in.data_handle(),
                    *scalar.data_handle(),
            ...
            {
                multiplyScalar<in_value_t, out_value_t, std::uint64_t>(
                    out.data_handle(),
                    in.data_handle(),
                    *scalar.data_handle(),
