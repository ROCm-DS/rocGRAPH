 ...
 */
                      ...
                      raft::device_matrix_view<ValueType, IndexType, LayoutPolicyZ>       z)
            {
                ...
                raft::copy(z_tmp.data(),
                           z.data_handle(),
                           z_tmp.size(),
                           raft::resource::get_cuda_stream(handle));

                auto z_tmp_view = is_row_major
                                      ? raft::make_device_strided_matrix_view<ValueType,
                                                                              IndexType,
                                                                              layout_c_contiguous>(
                ...
                detail::spmm(
                    handle, trans_x, trans_y, is_row_major, alpha, descr_x, descr_y, beta, descr_z);
