...
namespace raft::cluster::detail
{
   ...
   */
        ...
        raft::copy_async(
            coo1.weights.data() + coo1.n_edges, coo2.weights.data(), coo2.n_edges, stream);
 ...
 */
    ...
    void connect_knn_graph(raft::resources const&                                    handle,
                           const value_t*                                            X,
                           ...
                           = raft::distance::DistanceType::L2SqrtExpanded)
    {
        ...
        raft::sparse::neighbors::cross_component_nn<value_idx, value_t>(
            handle,
            connected_edges,
            X,
            color,
 ...
 */
    template <typename value_idx, typename value_t, typename red_op>
    void build_sorted_mst(raft::resources const&       handle,
                          const value_t*               X,
   ...
   */
        ...
        raft::sparse::op::coo_sort_by_weight(mst_coo.src.data(),
                                             mst_coo.dst.data(),
                                             mst_coo.weights.data(),
                                             mst_coo.n_edges,
                                             stream);
