 ...
 */
            ...
            raft::device_vector_view<OutT, IdxT, raft::layout_c_contiguous>        out)
        {
            ...
            RAFT_EXPECTS(x.extent(1) == y.extent(1),
                         "Dimension of vectors in x and y must be equal.");
            ...
            RAFT_EXPECTS(num_groups == adj.extent(1),
                         "#cols in `adj` must match length of `group_idxs`.");
