      ...
      printf("};\n");
            ...
            public:
                static_assert(SharedLoadIterator::Fragment::kElements
                                  == TensorTileIterator::Fragment::kElements,
            ...
            public:
                ...
                void operator()(
                    ...
                    OutputTileIterator
                        source_iterator, ///< Tile iterator for source accumulator matrix
                    TensorTileIterator
                        tensor_iterator, ///< Threadblock tile iterator for additional tensor operand
                    MatrixCoord const& problem_size
                    = ///< Problem size needed to guard against out-of-bounds accesses
                    MatrixCoord(Shape::kM, Shape::kN),
                    MatrixCoord const& threadblock_offset
                    = ///< Threadblock's initial offset within the problem size space
                    MatrixCoord())
                {
            ...
            private:
                ...
                )
                {
                    ...
                    NumericArrayConverter<ElementCompute,
                        ...
                        converter;
                    using AccessType
                        = AlignedArray<ElementVector, BroadcastDetail::kElementsPerAccess>;
...
#pragma unroll(IterationsUnroll ? OutputTileIterator::kIterations : 1)
                ...
                {
                    using AccessTypeT
                        = Array<typename TensorTileIterator::OutValT, kElementsPerAccess>;
                    ...
                    int const kOutputOpIterations = TensorTileIterator::Fragment::kElements
                                                    / TensorTileIterator::kElementsPerAccess;
