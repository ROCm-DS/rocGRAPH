        ...
        namespace kernel
        {
            ...
            struct PairwiseDistanceGemm
            {
                ...
                using ThreadblockShape = cutlass::gemm::
                    GemmShape<128, 128, 16>; // <- threadblock tile M = 128, N = 128, K = 16
                ...
                typedef typename std::conditional<isRowMajor,
                                                  cutlass::layout::RowMajor,
                                                  cutlass::layout::ColumnMajor>::type LayoutA_;

                typedef typename std::conditional<isRowMajor,
                                                  cutlass::layout::ColumnMajor,
                                                  cutlass::layout::RowMajor>::type LayoutB_;
                                        ...
                                        isRowMajor>
            {
                ...
                // Threadblock-level tile size (concept: GemmShape)
                using ThreadblockShape = cutlass::gemm::
                    GemmShape<64, 64, 16>; // <- threadblock tile M = 64, N = 64, K = 16
                /// Warp-level tile size (concept: GemmShape)
                // This code section describes tile size a warp will compute
                using WarpShape
                    = cutlass::gemm::GemmShape<32, 32, 16>; // <- warp tile M = 32, N = 32, K = 16
                /// Warp-level tile size (concept: GemmShape)
                // This code section describes the size of MMA op
