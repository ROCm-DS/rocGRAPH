...
#pragma unroll
            ...
            if(out_m < out.extent(0) && out_n < out.extent(1))
            {
                out(out_m, out_n) = out_elem;
            }
        }
    }
 ...
 */
                          ...
                          raft::device_matrix_view<T, int, raft::layout_c_contiguous>          out)
    {
        ...
        RAFT_EXPECTS(in.extent(1) == out.extent(1),
                     "Number of output columns must equal input columns.");
