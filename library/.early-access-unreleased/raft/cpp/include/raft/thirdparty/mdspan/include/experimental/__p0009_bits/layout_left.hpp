    ...
    namespace experimental
    {
        ...
        private:
            ...
            constexpr index_type
                __compute_offset(__rank_count<r, Rank>, const I& i, Indices... idx) const
            {
            ...
            template <class I>
            constexpr index_type
                __compute_offset(__rank_count<extents_type::rank() - 1, extents_type::rank()>,
                                 const I& i) const
            {
                return i;
            }
...
/*
        ...
        */
            ...
            {
                return _MDSPAN_FOLD_TIMES_RIGHT((Idx < N ? __extents.template __extent<Idx>() : 1),
                                                1);
            }
            template <size_t N>
