...
namespace std
{
    namespace experimental
    {
        ...
        namespace detail
        {
            ...
            static constexpr std::false_type
                _check_compatible_extents(std::false_type,
        ...
        public:
            ...
            using __storage_t = detail::__partially_static_sizes_tagged<detail::__extents_tag,
                                                                        index_type,
                                                                        size_t,
                                                                        Extents...>;
        ...
        private:
            ...
            MDSPAN_INLINE_FUNCTION constexpr bool
                _eq_impl(std::experimental::extents<OtherIndexType, OtherExtents...>,
                         false_type,
            ...
            template <class OtherIndexType, size_t... OtherExtents, size_t... Idxs>
            MDSPAN_INLINE_FUNCTION constexpr bool
                _not_eq_impl(std::experimental::extents<OtherIndexType, OtherExtents...>,
                             false_type,
                             index_sequence<Idxs...>) const noexcept
            {
                return true;
            ...
            template <class OtherIndexType, size_t... OtherExtents, size_t... Idxs>
            MDSPAN_INLINE_FUNCTION constexpr bool
                _not_eq_impl(std::experimental::extents<OtherIndexType, OtherExtents...> other,
                             true_type,
                             index_sequence<Idxs...>) const noexcept
            {
  ...
  */
            ...
            {
                return _MDSPAN_FOLD_PLUS_RIGHT((rank_type(Extents == dynamic_extent)),
                                               /* + ... + */ 0);
            }
                ...
                (
                    ...
                    decltype(detail::_check_compatible_extents(
                        std::integral_constant<bool,
                                               sizeof...(Extents) == sizeof...(OtherExtents)>{},
                        std::integer_sequence<size_t, Extents...>{},
     ...
     */
            ...
            MDSPAN_TEMPLATE_REQUIRES(
                ...
                /* requires */ (
                    ...
                    _MDSPAN_FOLD_AND(
                        _MDSPAN_TRAIT(is_convertible, Integral, index_type) /* && ... */)
                    && _MDSPAN_FOLD_AND(
            ...
            MDSPAN_TEMPLATE_REQUIRES(
                ...
                /* requires */ (_MDSPAN_FOLD_AND(_MDSPAN_TRAIT(
                                ...
                                && _MDSPAN_FOLD_AND(_MDSPAN_TRAIT(
                                    is_nothrow_constructible, index_type, Integral) /* && ... */)
     ...
     */
        ...
        namespace detail
        {
            ...
            struct __make_dextents<IndexType,
                                   Rank,
