    ...
    : public ::testing::Test
{
    ...
    using Fixture = TestExtents<std::tuple<stdex::extents<size_t, Extents...>,
...
TYPED_TEST(TestExtentsCompatCtors, construct_from_dynamic_sizes)
{
    ...
    e1_t e1 = TestFixture::template make_extents<e1_t, e1_t::rank(), false, e1_last_ext_static>::
        construct();
    ...
    e2_t e2 = TestFixture::template make_extents<e2_t, e2_t::rank(), false, e2_last_ext_static>::
        construct();
