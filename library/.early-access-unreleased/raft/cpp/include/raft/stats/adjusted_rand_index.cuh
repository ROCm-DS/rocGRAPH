 ...
 */
        ...
        double adjusted_rand_index(const T*     firstClusterArray,
                                   ...
                                   cudaStream_t stream)
        {
            return detail::compute_adjusted_rand_index(
 ...
 */
        ...
        double
            adjusted_rand_index(raft::resources const&                         handle,
        ...
        {
            RAFT_EXPECTS(first_cluster_array.size() == second_cluster_array.size(),
                         "Size mismatch");
            RAFT_EXPECTS(first_cluster_array.is_exhaustive(),
                         "first_cluster_array must be contiguous");
            RAFT_EXPECTS(second_cluster_array.is_exhaustive(),
                         "second_cluster_array must be contiguous");
