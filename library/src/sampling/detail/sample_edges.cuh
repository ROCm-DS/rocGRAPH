...
namespace rocgraph
{
    namespace detail
    {
                ...
                bool                                                            with_replacement)
        {
            ...
            rocgraph::vertex_frontier_t<vertex_t, tag_t, multi_gpu, false> vertex_frontier(handle,
                                                                                           1);
                ...
                if(edge_id_view)
                {
                    if(edge_type_view)
                    {
                        std::forward_as_tuple(
                            sample_offsets, std::tie(majors, minors, weights, edge_ids, edge_types))
                            = rocgraph::per_v_random_select_transform_outgoing_e(
                                ...
                                std::optional<
                                    thrust::
                                        tuple<vertex_t, vertex_t, weight_t, edge_t, edge_type_t>>{
                                    std::nullopt},
                                true);
                    }
                    else
                    {
                        std::forward_as_tuple(sample_offsets,
                            ...
                            = rocgraph::per_v_random_select_transform_outgoing_e(
                                ...
                                fanout,
                                with_replacement,
                                std::optional<thrust::tuple<vertex_t, vertex_t, weight_t, edge_t>>{
                                    std::nullopt},
                                true);
                    }
                }
                        ...
                        std::forward_as_tuple(sample_offsets, std::tie(majors, minors, weights))
                            = rocgraph::per_v_random_select_transform_outgoing_e(
                                ...
                                *edge_weight_view,
                                ...
                                fanout,
                                with_replacement,
                                std::optional<thrust::tuple<vertex_t, vertex_t, weight_t>>{
                                    std::nullopt},
                                true);
                    }
                }
                        ...
                        std::forward_as_tuple(sample_offsets, std::tie(majors, minors, edge_ids))
                            = rocgraph::per_v_random_select_transform_outgoing_e(
                                ...
                                *edge_id_view,
                                ...
                                fanout,
                                with_replacement,
                                std::optional<thrust::tuple<vertex_t, vertex_t, edge_t>>{
                                    std::nullopt},
                                true);
                    }
                }
                        ...
                        std::forward_as_tuple(sample_offsets, std::tie(majors, minors, edge_types))
                            = rocgraph::per_v_random_select_transform_outgoing_e(
                                ...
                                *edge_type_view,
                                ...
                                fanout,
                                with_replacement,
                                std::optional<thrust::tuple<vertex_t, vertex_t, edge_type_t>>{
                                    std::nullopt},
                                true);
                    }
                    else
            ...
            {
                labels = rmm::device_uvector<int32_t>(
