...
rocGRAPH Pagerank is implemented using our graph primitive library
...
//                          is expensive
rocgraph::pagerank(handle, graph_view, nullptr, nullptr, nullptr, vertex_t{0},
...
//                          executing algorithm.  Off by default.  Note: turning this on
//                          is expensive
rocgraph::pagerank(handle, graph_view, nullptr, personalization_vertices.data(),
