            ...
            thrust::transform(
                ...
                [src_scale,
                 ...
                 c_norm   = (1.0 - (a + b)) > 0.0 ? c / (1.0 - (a + b)) : 0.0] __device__(auto i) {
                    ...
                    for(int level = 0; level < static_cast<int>(std::max(src_scale, dst_scale));
                        ++level)
                    {
                        ...
                        if(level < src_scale)
                        {
                            ...
                            src += src_bit_set ? static_cast<vertex_t>(vertex_t{1}
                                                                       << (src_scale - (level + 1)))
                                               : 0;
                        ...
                        if(level < dst_scale)
                        {
                            ...
                            dst += dst_bit_set ? static_cast<vertex_t>(vertex_t{1}
                                                                       << (dst_scale - (level + 1)))
                                               : 0;
                        }
                    }
