// Copyright (C) 2009-2024 The Trustees of Indiana University.
 ...
 * permutation is not used because applying it at scale is too expensive. */
        ...
        __device__ vertex_t scramble(vertex_t value, size_t lgN)
        {
            ...
            static_assert((number_of_bits == 64) || (number_of_bits == 32)
                          || (number_of_bits == 16));
            ...
            constexpr auto scramble_value0 = static_cast<uvertex_t>(
                sizeof(vertex_t) == 8 ? 606610977102444280U
                                      : (sizeof(vertex_t) == 4 ? 282475248 : 0));
            constexpr auto scramble_value1 = static_cast<uvertex_t>(
                sizeof(vertex_t) == 8 ? 11680327234415193037U
                                      : (sizeof(vertex_t) == 4 ? 2617694917 : 8620));
