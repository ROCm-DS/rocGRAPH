...
namespace rocgraph
{
    ...
    {
        size_t num_edges = std::transform_reduce(
                ...
                component_parms_v)
    {
        ...
        for(auto tuple : component_parms_v)
        {
            ...
            auto z_iterator = thrust::make_zip_iterator(thrust::make_tuple(
                thrust::make_counting_iterator<vertex_t>(base_vertex_id),
        ...
        for(auto tuple : component_parms_v)
        {
            ...
            auto transform_iter                    = thrust::make_transform_iterator(
                ...
                [base_vertex_id, num_vertices, invalid_vertex] __device__(
                    ...
                    vertex_t src
                        = base_vertex_id + static_cast<vertex_t>(local_index / num_vertices);
                    vertex_t dst
                        = base_vertex_id + static_cast<vertex_t>(local_index % num_vertices);
