...
namespace rocgraph
{
    ...
    namespace detail
    {
            ...
            EdgeOp                                         e_op)
        {
            ...
            using BlockReduce
                = hipcub::BlockReduce<e_op_result_t, transform_reduce_e_kernel_block_size>;
            ...
            if(threadIdx.x == 0)
            {
                atomic_add(result_iter, e_op_result_sum);
            }
        }
 ...
 */
                            ...
                            bool                     do_expensive_check = false)
    {
        ...
        using T           = typename detail::
            edge_op_result_type<vertex_t, vertex_t, src_value_t, dst_value_t, e_value_t, EdgeOp>::
                type;
