...
namespace rocgraph
{
    ...
    namespace detail
    {
        ...
        auto get_optional_dataframe_buffer_begin(
            std::decay_t<decltype(allocate_dataframe_buffer<T>(
        ...
        auto get_optional_dataframe_buffer_cbegin(
            std::decay_t<decltype(allocate_dataframe_buffer<T>(
                size_t{0}, rmm::cuda_stream_view{}))> const& optional_dataframe_buffer)
        {
        ...
        void reserve_optional_dataframe_buffer(
            ...
            rmm::cuda_stream_view                      stream_view)
        {
            return reserve_dataframe_buffer(
                optional_dataframe_buffer, new_buffer_capacity, stream_view);
        }
