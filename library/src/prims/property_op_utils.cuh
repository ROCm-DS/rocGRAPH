...
namespace rocgraph
{
    ...
    namespace detail
    {
                ...
                std::is_invocable_v<EdgeOp, key_t, vertex_t, src_value_t, dst_value_t, e_value_t>>>
        {
            using type = typename std::
                invoke_result<EdgeOp, key_t, vertex_t, src_value_t, dst_value_t, e_value_t>::type;
        };
    ...
    struct cast_edge_op_bool_to_integer
    {
        ...
        template <typename K  = key_t,
                  ...
                  typename E  = EdgeOp>
        __device__ std::enable_if_t<std::is_invocable_v<E, K, V, SV, DV, EV>, T>
                   operator()(K s, V d, SV sv, DV dv, EV ev) const
        {
    ...
    struct property_op<thrust::tuple<Args...>, Op>
        : public thrust::binary_function<thrust::tuple<Args...>,
                                         thrust::tuple<Args...>,
                                         thrust::tuple<Args...>>
    {
    ...
    private:
        ...
        __host__ __device__ constexpr auto
            binary_op_impl(T& t1, T& t2, std::index_sequence<Is...>) const
        {
    ...
    public:
        ...
        {
            return binary_op_impl(
                t1, t2, std::make_index_sequence<thrust::tuple_size<Type>::value>());
        }
    };
