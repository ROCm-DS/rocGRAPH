 ...
 */
    ...
    namespace Sparse
    {
                                                    ...
                                                    vertex_t        batchSize)
        {
            ...
            if(tid < batchSize)
            {
                if(fa[tid + startVertexId])
                {
                    ...
                    //
                    // NOTE: reworked this loop.  In rocgraph offsets is one element
                                   ...
                                   Lambda          filter_op)
        {
            ...
            THROW_IF_HIPLAUNCHKERNELGGL_ERROR((weak_cc_init_label_kernel<vertex_t, TPB_X>),
                                              blocks,
                                              threads,
                                              0,
                                              stream,
            ...
            do
            {
                ...
                THROW_IF_HIPLAUNCHKERNELGGL_ERROR((weak_cc_label_device<vertex_t, edge_t, TPB_X>),
                                                  blocks,
                                                  threads,
                                                  0,
                                                  stream,
 ...
 */
                             ...
                             Lambda          filter_op)
        {
            ...
            if(startVertexId == 0)
            {
                THROW_IF_HIPLAUNCHKERNELGGL_ERROR((weak_cc_init_all_kernel<vertex_t, TPB_X>),
                                                  blocks,
                                                  threads,
                                                  0,
                                                  stream,
            ...
            weak_cc_label_batched<vertex_t, edge_t, TPB_X>(labels,
                                                           offsets,
                                                           indices,
                                                           nnz,
                                                           N,
