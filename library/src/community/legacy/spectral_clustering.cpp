...
#ifdef ROCGRAPH_SPECTRAL_IMPLEMENTED
...
namespace rocgraph
{
    ...
    namespace ext_raft
    {
        ...
        namespace detail
        {
            ...
            void balancedCutClustering_impl(
                ...
                weight_t*                                               eig_vects)
            {
                ...
                RAFT_EXPECTS(
                    n_clusters < graph.number_of_vertices,
...
#else
                ROCGRAPH_FAIL("balancedCutClustering not implemented");
#endif
            }
...
#else
                ROCGRAPH_FAIL("spectralModularityMaximization not implemented");
#endif
            }
                ...
                weight_t*                                               modularity)
            {
                ...
                *modularity = mod;
#else
                ROCGRAPH_FAIL("analyzeModularityClustering not implemented");
#endif
            }

            template <typename vertex_t, typename edge_t, typename weight_t>
            void analyzeBalancedCut_impl(
                legacy::GraphCSRView<vertex_t, edge_t, weight_t> const& graph,
                vertex_t                                                n_clusters,
                vertex_t const*                                         clustering,
                weight_t*                                               edgeCut,
                weight_t*                                               ratioCut)
            {
                ...
                raft::spectral::analyzePartition(
                    handle, r_csr_m, n_clusters, clustering, edge_cut, cost);

                *edgeCut  = edge_cut;
                *ratioCut = cost;
#else
                ROCGRAPH_FAIL("analyzeBalancedCut not implemented");
#endif
            }
        ...
        template void
            balancedCutClustering<int, int, double>(legacy::GraphCSRView<int, int, double> const&,
                                                    int,
                                                    int,
                                                    double,
                                                    int,
