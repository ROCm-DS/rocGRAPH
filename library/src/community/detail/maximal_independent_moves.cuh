...
namespace rocgraph
{
    ...
    namespace detail
    {
        ...
        {
            using GraphViewType = rocgraph::graph_view_t<vertex_t, edge_t, false, multi_gpu>;

            vertex_t local_vtx_partitoin_size = graph_view.local_vertex_partition_range_size();

            rmm::device_uvector<vertex_t> remaining_vertices(local_vtx_partitoin_size,
                                                             handle.get_stream());
            ...
            while(true)
            {
                ...
                rmm::device_uvector<vertex_t> temporary_ranks(local_vtx_partitoin_size,
                                                              handle.get_stream());
                thrust::copy(handle.get_thrust_policy(),
                             ranks.begin(),
                             ranks.end(),
                             temporary_ranks.begin());
                ...
                vertex_t nr_candidates
                    = (nr_remaining_vertices_to_check < 1024)
                          ? nr_remaining_vertices_to_check
                ...
                auto d_sampled_vertices = rocgraph::select_random_vertices(
                    handle,
                    graph_view,
                ...
                if constexpr(multi_gpu)
                {
                    ...
                    update_edge_src_property(
                        handle, graph_view, temporary_ranks.begin(), src_rank_cache);
                    update_edge_dst_property(
                        handle, graph_view, temporary_ranks.begin(), dst_rank_cache);
                }
                ...
                rmm::device_uvector<vertex_t> max_outgoing_ranks(local_vtx_partitoin_size,
                                                                 handle.get_stream());
                ...
                per_v_transform_reduce_outgoing_e(
                    ...
                    rocgraph::reduce_op::maximum<vertex_t>{},
                ...
                rmm::device_uvector<vertex_t> max_incoming_ranks(local_vtx_partitoin_size,
                                                                 handle.get_stream());
                ...
                if(nr_remaining_vertices_to_check == 0)
                {
                    break;
                }
            }
