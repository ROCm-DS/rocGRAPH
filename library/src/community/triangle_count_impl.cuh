...
namespace rocgraph
{
    ...
    namespace
    {
        ...
        {
            __host__ __device__ bool operator()(edge_t core_number) const
            {
                return core_number >= edge_t{2};
            }
        };
        ...
        {
            __host__ __device__ thrust::tuple<edge_t, edge_t, edge_t>
                                operator()(vertex_t,
                           vertex_t,
                           thrust::nullopt_t,
                           thrust::nullopt_t,
        ...
        struct vertex_to_count_t
        {
            ...
            __host__ __device__ edge_t operator()(vertex_t v) const
            {
                ...
                {
                    return *(local_counts.begin()
                             + thrust::distance(sorted_local_vertices.begin(), it));
                }
                else
                {
                    return edge_t{0};
                        ...
                        bool                                                    do_expensive_check)
    {
        ...
        else
        {
            ROCGRAPH_EXPECTS(
                ...
                "Invalid arguments: counts.size() does not coincide with the number of local "
                "vertices.");
        }
        ...
        if(vertices.has_value() && ((*vertices).size() == 0))
        {
            return;
        }
        ...
        if(unmasked_cur_graph_view.has_edge_mask())
        {
            unmasked_cur_graph_view.clear_edge_mask();
        }
        ...
        {
            /* edge_property_bool */
            rocgraph::edge_property_t<decltype(cur_graph_view), bool> within_two_hop_edge_mask(
                handle, cur_graph_view);
            rocgraph::fill_edge_property(
                handle, unmasked_cur_graph_view, false, within_two_hop_edge_mask);
            ...
            unique_vertices.resize(thrust::distance(unique_vertices.begin(),
            ...
            std::tie(std::ignore, one_hop_nbrs) = rocgraph::k_hop_nbrs(
                handle,
                cur_graph_view,
                raft::device_span<vertex_t const>(unique_vertices.data(), unique_vertices.size()),
                size_t{1});

            rmm::device_uvector<vertex_t> unique_one_hop_nbrs(one_hop_nbrs.size(),
                                                              handle.get_stream());
            thrust::copy(handle.get_thrust_policy(),
                         one_hop_nbrs.begin(),
                         one_hop_nbrs.end(),
            ...
            {
                unique_one_hop_nbrs
                    = detail::shuffle_int_vertices_to_local_gpu_by_vertex_partitioning(
                        handle,
                ...
                thrust::sort(handle.get_thrust_policy(),
                             unique_one_hop_nbrs.begin(),
                             unique_one_hop_nbrs.end());
                unique_one_hop_nbrs.resize(
                    thrust::distance(unique_one_hop_nbrs.begin(),
                                     thrust::unique(handle.get_thrust_policy(),
                                                    unique_one_hop_nbrs.begin(),
                                                    unique_one_hop_nbrs.end())),
                    handle.get_stream());
            ...
            std::tie(std::ignore, two_hop_nbrs)
                = rocgraph::k_hop_nbrs(handle,
                                       cur_graph_view,
                                       raft::device_span<vertex_t const>(
                                           unique_one_hop_nbrs.data(), unique_one_hop_nbrs.size()),
                                       size_t{1});

            rmm::device_uvector<vertex_t> unique_two_hop_nbrs(two_hop_nbrs.size(),
                                                              handle.get_stream());
            thrust::copy(handle.get_thrust_policy(),
                         two_hop_nbrs.begin(),
                         two_hop_nbrs.end(),
            ...
            if constexpr(multi_gpu)
            {
                ...
                thrust::sort(handle.get_thrust_policy(),
                             unique_two_hop_nbrs.begin(),
                             unique_two_hop_nbrs.end());
                unique_two_hop_nbrs.resize(
                    thrust::distance(unique_two_hop_nbrs.begin(),
                                     thrust::unique(handle.get_thrust_policy(),
                                                    unique_two_hop_nbrs.begin(),
                                                    unique_two_hop_nbrs.end())),
                    handle.get_stream());
            ...
            thrust::fill(handle.get_thrust_policy(),
                         ...
                         within_two_hop_flags.end(),
                         false);
            thrust::for_each(handle.get_thrust_policy(),
                             unique_vertices.begin(),
                             unique_vertices.end(),
                             [within_two_hop_flags = raft::device_span<bool>(
                                  within_two_hop_flags.data(), within_two_hop_flags.size()),
                              local_vertex_partition_range_first
                              = cur_graph_view.local_vertex_partition_range_first()] __host__
                                 __device__(auto v) {
            ...
            update_edge_src_property(handle,
                                     cur_graph_view,
                                     within_two_hop_flags.begin(),
                                     edge_src_within_two_hop_flags);
            update_edge_dst_property(handle,
                                     cur_graph_view,
                                     within_two_hop_flags.begin(),
                                     edge_dst_within_two_hop_flags);
            ...
            transform_e(
                ...
                [] __host__ __device__(
                    auto, auto, auto src_within_two_hop, auto dst_within_two_hop, auto) {
            ...
            if(cur_graph_view.has_edge_mask())
            {
        ...
        {
            /* edge_property_bool */
            rocgraph::edge_property_t<decltype(cur_graph_view), bool> self_loop_edge_mask(
                handle, cur_graph_view);
            rocgraph::fill_edge_property(
                handle, unmasked_cur_graph_view, false, self_loop_edge_mask);
        ...
        {
            /* edge_property_bool */
            rocgraph::edge_property_t<decltype(cur_graph_view), bool> in_two_core_edge_mask(
                handle, cur_graph_view);
            rocgraph::fill_edge_property(
                handle, unmasked_cur_graph_view, false, in_two_core_edge_mask);
            ...
            edge_src_property_t<decltype(cur_graph_view), bool> edge_src_in_two_cores(
                handle, cur_graph_view);
            edge_dst_property_t<decltype(cur_graph_view), bool> edge_dst_in_two_cores(
                handle, cur_graph_view);
            auto in_two_core_first = thrust::make_transform_iterator(core_numbers.begin(),
                                                                     is_two_or_greater_t<edge_t>{});
            ...
            transform_e(
                ...
                edge_dummy_property_t{}.view(),
                [] __host__ __device__(
                    auto, auto, auto src_in_two_core, auto dst_in_two_core, auto) {
            ...
            if(vertices)
            {
                thrust::transform(
                    ...
                    vertex_to_count_t<vertex_t, edge_t>{
                        raft::device_span<vertex_t const>(local_vertices.begin(),
                                                          local_vertices.end()),
            ...
            else
            {
                thrust::scatter(handle.get_thrust_policy(),
                                ...
                                thrust::make_transform_iterator(
                                    local_vertices.begin(),
                                    vertex_offset_from_vertex_t<vertex_t>{
                                        graph_view.local_vertex_partition_range_first()}),
                                counts.begin());
            }
        }
