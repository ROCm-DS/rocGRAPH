...
namespace
{
    ...
    struct wcc_functor : public rocgraph::c_api::abstract_functor
    {
        ...
        wcc_functor(rocgraph_handle_t const* handle,
        ...
        void operator()()
        {
            ...
            else
            {
                ...
                rmm::device_uvector<vertex_t> components(
                    graph_view.local_vertex_partition_range_size(), handle_.get_stream());

                rocgraph::weakly_connected_components<vertex_t, edge_t, multi_gpu>(
...
extern "C" rocgraph_status rocgraph_weakly_connected_components(const rocgraph_handle_t* handle,
                                                                rocgraph_graph_t*        graph,
