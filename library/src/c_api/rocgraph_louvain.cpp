...
namespace
{
    ...
    struct louvain_functor : public rocgraph::c_api::abstract_functor
    {
        ...
        louvain_functor(::rocgraph_handle_t const* handle,
        ...
        void operator()()
        {
            ...
            else
            {
                ...
                // coarsened graphs.
                auto [level, modularity] = rocgraph::louvain(
                    handle_,
...
extern "C" rocgraph_status rocgraph_louvain(const rocgraph_handle_t* handle,
                                            rocgraph_graph_t*        graph,
                                            size_t                   max_level,
                                            double                   threshold,
                                            double                   resolution,
