...
namespace rocgraph
{
    namespace c_api
    {
        ...
        struct sssp_functor : public abstract_functor
        {
            ...
            sssp_functor(::rocgraph_handle_t const* handle,
            ...
            void operator()()
            {
                ...
                else
                {
                    ...
                    rmm::device_uvector<weight_t> distances(
                    ...
                    rocgraph::sssp<vertex_t, edge_t, weight_t, multi_gpu>(
                        handle_,
                        graph_view,
                        edge_weights->view(),
                        distances.data(),
                    ...
                    result_ = new rocgraph_paths_result_t{
                        ...
                        new rocgraph_type_erased_device_array_t(distances, graph_->weight_type_),
...
extern "C" rocgraph_status rocgraph_sssp(const rocgraph_handle_t*  handle,
                                         rocgraph_graph_t*         graph,
                                         size_t                    source,
                                         double                    cutoff,
...
{
    rocgraph::c_api::sssp_functor functor(
