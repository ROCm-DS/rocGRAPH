...
namespace rocgraph
{
    ...
    namespace
    {
        ...
        std::tuple<rmm::device_uvector<vertex_t>,
            ...
            groupby_e_and_coarsen_edgelist(
                ...
                rmm::cuda_stream_view                          stream_view)
        {
            ...
            if(edgelist_weights)
            {
                ...
                rmm::device_uvector<vertex_t> tmp_edgelist_minors(tmp_edgelist_majors.size(),
                                                                  stream_view);
                rmm::device_uvector<weight_t> tmp_edgelist_weights(tmp_edgelist_majors.size(),
                                                                   stream_view);
                thrust::reduce_by_key(
                    ...
                    pair_first + edgelist_majors.size(),
                    (*edgelist_weights).begin(),
                    thrust::make_zip_iterator(thrust::make_tuple(tmp_edgelist_majors.begin(),
                                                                 tmp_edgelist_minors.begin())),
            ...
            else
            {
                ...
                return std::make_tuple(
                    std::move(edgelist_majors), std::move(edgelist_minors), std::nullopt);
            }
        }
        ...
        std::tuple<rmm::device_uvector<vertex_t>,
            ...
            decompress_edge_partition_to_relabeled_and_grouped_and_coarsened_edgelist(
                ...
                std::optional<detail::edge_partition_edge_property_device_view_t<
                    edge_t,
                    packed_bool_container_t const*,
                    bool>>                                  edge_partition_e_mask,
        ...
        {
            static_assert(
                std::is_same_v<typename EdgeMinorLabelInputWrapper::value_type, vertex_t>);
            ...
            rmm::device_uvector<vertex_t> edgelist_majors(
                ...
                handle.get_stream());
            rmm::device_uvector<vertex_t> edgelist_minors(edgelist_majors.size(),
                                                          handle.get_stream());
    ...
    namespace detail
    {
                ...
                bool do_expensive_check)
        {
            ...
            std::conditional_t<
                store_transposed,
                edge_src_property_t<graph_view_t<vertex_t, edge_t, store_transposed, multi_gpu>,
                                    vertex_t>,
                edge_dst_property_t<graph_view_t<vertex_t, edge_t, store_transposed, multi_gpu>,
                                    vertex_t>>
            ...
            for(size_t i = 0; i < graph_view.number_of_local_edge_partitions(); ++i)
            {
                    ...
                    = decompress_edge_partition_to_relabeled_and_grouped_and_coarsened_edgelist(
                        ...
                        edge_weight_view
                            ? std::make_optional<detail::edge_partition_edge_property_device_view_t<
                                  edge_t,
                                  weight_t const*>>(*edge_weight_view, i)
                            : std::nullopt,
                        edge_mask_view
                            ? std::make_optional<detail::edge_partition_edge_property_device_view_t<
                                  edge_t,
                ...
                std::tie(
                    edgelist_majors, edgelist_minors, edgelist_weights, std::ignore, std::ignore)
                    = rocgraph::detail::
                ...
                if(edgelist_weights)
                {
                    (*coarsened_edgelist_weights).push_back(std::move(*edgelist_weights));
                }
            }
            ...
            rmm::device_uvector<vertex_t> concatenated_edgelist_majors(tot_count,
                                                                       handle.get_stream());
            ...
            rmm::device_uvector<vertex_t> concatenated_edgelist_minors(tot_count,
                                                                       handle.get_stream());
            ...
            std::optional<rmm::device_uvector<weight_t>> concatenated_edgelist_weights{
                std::nullopt};
            if(coarsened_edgelist_weights)
            {
                concatenated_edgelist_weights
                    = rmm::device_uvector<weight_t>(tot_count, handle.get_stream());
            ...
            std::tie(concatenated_edgelist_majors,
            ...
            if(lower_triangular_only)
            {
                ...
                std::optional<rmm::device_uvector<weight_t>> reversed_edgelist_weights{
                    std::nullopt};

                if(concatenated_edgelist_weights)
                {
                    auto edge_first = thrust::make_zip_iterator(
                        thrust::make_tuple(concatenated_edgelist_majors.begin(),
                    ...
                    reversed_edgelist_majors.resize(thrust::distance(edge_first, last),
                                                    handle.get_stream());
                    reversed_edgelist_minors.resize(reversed_edgelist_majors.size(),
                                                    handle.get_stream());
                    reversed_edgelist_weights = rmm::device_uvector<weight_t>(
                        reversed_edgelist_majors.size(), handle.get_stream());
                    thrust::copy(handle.get_thrust_policy(),
                                 edge_first,
                                 edge_first + reversed_edgelist_majors.size(),
                                 thrust::make_zip_iterator(
                                     thrust::make_tuple(reversed_edgelist_minors.begin(),
                ...
                concatenated_edgelist_majors.resize(concatenated_edgelist_majors.size()
                                                        + reversed_edgelist_majors.size(),
                                                    handle.get_stream());
                thrust::copy(handle.get_thrust_policy(),
                             reversed_edgelist_majors.begin(),
                ...
                concatenated_edgelist_minors.resize(concatenated_edgelist_majors.size(),
                                                    handle.get_stream());
                thrust::copy(handle.get_thrust_policy(),
            ...
            rmm::device_uvector<vertex_t> unique_labels(
                ...
                bool do_expensive_check)
        {
            if(do_expensive_check)
            {
                if(!renumber)
                {
                    ...
                    ROCGRAPH_EXPECTS(num_invalids == 0,
                                     "Invalid input aguments: if renumber is false, labels should "
                                     "be non-negative "
            ...
            auto [coarsened_edgelist_majors, coarsened_edgelist_minors, coarsened_edgelist_weights]
                = decompress_edge_partition_to_relabeled_and_grouped_and_coarsened_edgelist(
                    ...
                    edge_weight_view
                        ? std::make_optional<
                              detail::edge_partition_edge_property_device_view_t<edge_t,
                                                                                 weight_t const*>>(
                              *edge_weight_view, 0)
                        : std::nullopt,
                    edge_mask_view
                        ...
                        : std::nullopt,
                    labels,
                    detail::edge_minor_property_view_t<vertex_t, vertex_t const*>(labels,
                                                                                  vertex_t{0}),
            ...
            if(lower_triangular_only)
            {
                ...
                {
                    auto edge_first = thrust::make_zip_iterator(
                        thrust::make_tuple(coarsened_edgelist_majors.begin(),
                    ...
                    coarsened_edgelist_minors.resize(coarsened_edgelist_majors.size(),
                                                     handle.get_stream());
                    (*coarsened_edgelist_weights)
                        .resize(coarsened_edgelist_majors.size(), handle.get_stream());
                    ...
                    thrust::copy(handle.get_thrust_policy(),
                                 ...
                                 thrust::make_zip_iterator(
                                     thrust::make_tuple(coarsened_edgelist_minors.begin(),
                ...
                else
                {
                    auto edge_first = thrust::make_zip_iterator(thrust::make_tuple(
                        coarsened_edgelist_majors.begin(), coarsened_edgelist_minors.begin()));
                    auto last       = thrust::partition(
                        handle.get_thrust_policy(),
                        edge_first,
                        edge_first + coarsened_edgelist_majors.size(),
            ...
            rmm::device_uvector<vertex_t> vertices(graph_view.number_of_vertices(),
                                                   handle.get_stream());
            if(renumber)
            {
                thrust::copy(
                    handle.get_thrust_policy(), labels, labels + vertices.size(), vertices.begin());
