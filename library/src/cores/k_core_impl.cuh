...
namespace rocgraph
{
               ...
               bool                                                         do_expensive_check)
    {
        ...
        if(!core_numbers)
        {
            ROCGRAPH_EXPECTS(degree_type.has_value(),
            ...
            core_numbers = std::make_optional(raft::device_span<edge_t const>{
                computed_core_numbers.data(), computed_core_numbers.size()});
        }
        ...
        subgraph_vertices.resize(
            thrust::distance(thrust::make_zip_iterator(subgraph_vertices.begin(),
